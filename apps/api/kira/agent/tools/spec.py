...
ToolKind = Literal["read", "write", "workflow", "ui"]
...
class ToolSpec:
    ...
    def __post_init__(self) -> None:
        ...
        if self.kind not in ("read", "write", "workflow", "ui"):
...
class ToolRegistry:
    ...
    def ui(self) -> tuple[ToolSpec, ...]:
        return tuple(spec for spec in self if spec.kind == "ui")
